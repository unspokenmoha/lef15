...
const CarouselCard1: React.FC<CarouselCardProps> = ({
  ...
  image = "https://images.pexels.com/photos/1082529/pexels-photo-1082529.jpeg?auto=compress&cs=tinysrgb&w=800&h=400",
  ...
  return (
    <div className="relative min-w-full md:min-w-[600px] h-80 rounded-2xl overflow-hidden group cursor-pointer">
      {/* Background Image */}
      <div 
